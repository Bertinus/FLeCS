...
for epoch in range(50):
    train_epoch(mycellpop, train_dataloader, optimizer, path_length=2, loss=loss, max_n_batch=50)

torch.save({
    **mycellpop["gene"].state_dict(),
    **mycellpop["gene", "regulates", "gene"].state_dict()
},
    os.path.join(get_project_root(), "logs", "trained_mycellpop_mar_07_1.pt")
)
